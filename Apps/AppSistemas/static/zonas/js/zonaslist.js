        ...
        columnDefs: [ //Defino la caracteristica de las columnas
            {
                ...
                render: function (data, type, row) {
                    var buttons = '<a href="/sis/zonas/update/' + row.id + '/" type="button" class="btn btn-outline-success btn-sm"><i class="fas fa-pencil-alt"></i></a> ';
                    buttons += '<a href="/sis/zonas/delete/' + row.id + '/" type="button" class="btn btn-outline-danger btn-sm"><i class="fas fa-eraser"></i></a>';
                    return buttons;
                }
            },
        ],
